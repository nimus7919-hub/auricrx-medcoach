...
const Medications = ({ theme, meds, setMeds, S, themeKey, onNavigateToDashboard, onNavigateToSettings }) => {
          ...
          <View key={med.id} style={{
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
              ...
              <View style={{ flexDirection: 'row', gap: 8 }}>
                ...
                >
                  <Text style={{ color: themeKey === 'gold' ? '#2c2c2c' : '#000000', fontSize: 12, fontFamily: 'Inter_600SemiBold' }}>
                    {S.edit}
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
              ...
              >
                ...
                >
                  <Text style={{ color: theme.text, fontFamily: 'Inter_400Regular' }}>
                    {addTimes.length > 0 ? addTimes.join(', ') : 'Select times'}
                  </Text>
                ...
                >
                  <Text style={{ color: theme.text, fontFamily: 'Inter_400Regular' }}>
                    {addForm.endDate || 'End Date (optional)'}
                  </Text>
                  <Text style={{ color: theme.sub }}>📅</Text>
                </TouchableOpacity>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Text style={{ color: theme.text, fontFamily: 'Inter_400Regular' }}>
                    {editTimes.length > 0 ? editTimes.join(', ') : 'Select times'}
                  </Text>
                  <Text style={{ color: theme.sub }}>⏰</Text>
                </TouchableOpacity>
                ...
                >
                  <Text style={{ color: theme.text, fontFamily: 'Inter_400Regular' }}>
                    {editForm.endDate || 'End Date (optional)'}
                  </Text>
                  <Text style={{ color: theme.sub }}>📅</Text>
                </TouchableOpacity>
