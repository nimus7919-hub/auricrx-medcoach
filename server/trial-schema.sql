-- AuricRX Trial & Subscription Schema Migration
-- Run this in your Neon SQL editor to add trial and subscription support

-- ========================================
-- 1. ADD TRIAL/SUBSCRIPTION COLUMNS TO user_profiles
-- ========================================
...
-- ========================================
-- 2. ADD INDEXES FOR ELIGIBILITY CHECKS
-- ========================================
...
-- ========================================
-- 3. CREATE health_data TABLE FOR CLOUD SYNC
-- ========================================
...
CREATE TABLE IF NOT EXISTS health_data (
  ...
  data_type TEXT NOT NULL, -- 'medication', 'health_metric', 'symptom', 'appointment', etc.
...
-- ========================================
-- 4. ENABLE RLS ON health_data
-- ========================================

ALTER TABLE health_data ENABLE ROW LEVEL SECURITY;

CREATE POLICY health_data_user_isolation 
...
-- ========================================
-- 6. HELPER FUNCTION: GET USER SUBSCRIPTION STATUS
-- ========================================
...
-- ========================================
-- 7. MIGRATION: SET EXISTING USERS TO trial ELIGIBLE
-- ========================================

-- This will set all existing users to have a trial
